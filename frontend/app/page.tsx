...
// Add sample articles array at the top of the file
const articles = [
  {
    id: 1,
    title: "10 Tips for Successful Blogging",
    excerpt: "Learn how to create engaging blog content that drives traffic and builds your audience with these proven strategies.",
  ...
  },
  {
    ...
    excerpt: "Explore the cutting-edge technologies and frameworks that are transforming how we build web applications.",
    content: "Full blog post content would go here...",
    author: "Mike Chen",
    authorId: 3,
    date: "2024-01-10",
